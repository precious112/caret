		...
		<ul className="text-sm pl-3 list-disc" style={{ color: "var(--vscode-descriptionForeground)" }}>
			{hasWelcomeBanners ? (
				...
				<>
					...
					<li className="mb-2">
						<strong>Try Codex 5.3:</strong> OpenAI's latest coding model, now available in Caret!{" "}
						<InlineModelLink label="Try now" modelId="openai/gpt-5.3-codex" pickerTab="recommended" />
					</li>
					<li className="mb-2">
						<strong>Try latest SOTA coding model:</strong> Claude Sonnet 4.6 and Gemini 3.1 pro within Caret!{" "}
